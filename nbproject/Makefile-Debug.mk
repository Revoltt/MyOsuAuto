...
${OBJECTDIR}/GeneralMovement.o: GeneralMovement.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/GeneralMovement.o GeneralMovement.cpp

${OBJECTDIR}/OsuFileParser.o: OsuFileParser.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/OsuFileParser.o OsuFileParser.cpp

${OBJECTDIR}/OsuMovement.o: OsuMovement.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/OsuMovement.o OsuMovement.cpp
...
${OBJECTDIR}/parser/Circle.o: parser/Circle.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/parser/Circle.o parser/Circle.cpp
...
${OBJECTDIR}/parser/Spinner.o: parser/Spinner.cpp
	${MKDIR} -p ${OBJECTDIR}/parser
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/parser/Spinner.o parser/Spinner.cpp

${OBJECTDIR}/parser/TimingPoint.o: parser/TimingPoint.cpp
	${MKDIR} -p ${OBJECTDIR}/parser
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/parser/TimingPoint.o parser/TimingPoint.cpp
